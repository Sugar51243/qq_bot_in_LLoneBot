...
# 由v1(src/tools/image_cuter.py)迁移至v2，改为同步函数
...
#图片切割函数
def split_image(image_path = None, image_data = None, image_uri = None, num = 0, cut_left = False, vertical_segment = None, piece = 4):
